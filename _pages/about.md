...
- **B.Eng.**, Shanghai Jiao Tong University (SJTU), 2020 - 2024
  ...
  - Awarded the Zhiyuan Honor Scholarship at Shanghai Jiao Tong University.
...
(**Equal Contribution / Corresponding Author** notation is omitted)
...
My research work centers on natural language processing and machine learning, with specific expertise in large language model reasoning, reinforcement learning, vision-language model hallucination, and LLM truthfulness and interpretability.
